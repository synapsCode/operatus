<section class="relative flex p-9 sm:py-24" id="surveyors">
	<div class="max-w-[1200px] w-full mx-auto sm:flex items-center">
		...
		<div class="basis-1/2 sm:py-0 py-8">
			<a
				href="/"
				class="max-w-xs text-xs tracking-widest uppercase font-semibold h-10 px-12 rounded-full flex items-center justify-center sm:ml-auto bg-red-700 text-slate-50"
				>Log in</a
			>
		</div>
	</div>
